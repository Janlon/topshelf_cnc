...
namespace Cancela
{
    public class Regras : Base
    {
            ...
            try
            {
                ...
                try
                {
                    ...
                    while (!this.v_BuscaResultadoLBF)
                    {
                        ...
                        ++num4;
                        if (num4 < 10)
                            new Logar().ILogar(v_s_Aplicacao.ToString(), this.v_Secao, v_Id_Equipamento, 24, this.v_Credencial, "BUSCOU LBF : SESSÃO : " + v_Secao + "-" + num4, null, "E", nameof(LBF));
                        else
                            break;
                    }
                    if ((double)num2 == -1.0)
        ...
        public async void Libera_Acesso_Registra_Lap(IPAddress v_IP, int v_Porta_Envio)
        {
            ...
            {
                new GravaAcessoPatio().GravarAcessoPatio("E", 0, Regras.v_Id_Equipamento, Regras.v_s_Aplicacao, "", 0L, "", "", "", "", "", "", "");
                new Logar().ILogar(v_s_Aplicacao.ToString(), this.v_Secao, Regras.v_Id_Equipamento, 12, this.v_Credencial_Pessoa, "Atualizando Vagas", (string)null, "E", "Entrada");
            }
            this.EncerraSecao(this.v_s_IP.ToString(), "TERMINO DA SECAO", this.v_s_Porta_Envio, this.v_s_IP);
        }
